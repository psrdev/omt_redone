...
const contactItems = [
  ...
  {
    title: "Email",
    value: "marketing@outmazedtourism.com",
    href: "mailto:marketing@outmazedtourism.com",
    icon: faEnvelope,
  },
];

export default function MarketingMediaContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Marketing Media Legal Form submitted:", formData);
      ...
      >
        <motion.div className={styles.sectionHeader} variants={fadeUp}>
          <div className={styles.eyebrow}>
            ...
            <span className={styles.eyebrowText}>Marketing, Media & Legal</span>
          </div>

          <h2>
            Connect With Our Brand Team <br />
            <em>For Official Inquiries.</em>
          </h2>

          <p>
            For marketing collaborations, media requests, press communication,
            brand partnerships, legal notices, or official documentation, reach
            the right OutMazed team directly.
          </p>
        </motion.div>
        ...
        <motion.div className={styles.contactLayout} variants={fadeUp}>
          <aside className={styles.infoColumn}>
            ...
            <div className={styles.infoIntro}>
              <span className={styles.panelLabel}>Official Desk</span>

              <h3>Get In Touch</h3>

              <p>
                For media, marketing, press, legal, brand communication, and
                official corporate enquiries.
              </p>
            </div>
          ...
          <div className={styles.formPanel}>
            ...
            <div className={styles.formHeader}>
              ...
              <p>
                Share your request and our team will route it to the right
                marketing, media, or legal department.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className={styles.inputGroup}>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  placeholder="Tell us about your marketing, media, or legal inquiry..."
                />
              </div>

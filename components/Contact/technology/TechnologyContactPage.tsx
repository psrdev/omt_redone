...
const contactItems = [
  ...
  {
    title: "Email",
    value: "tech@outmazedtourism.com",
    href: "mailto:tech@outmazedtourism.com",
    icon: faEnvelope,
  },
];
...
export default function TechnologyContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Technology Form submitted:", formData);
      ...
      >
        <motion.div className={styles.sectionHeader} variants={fadeUp}>
          <div className={styles.eyebrow}>
            ...
            <span className={styles.eyebrowText}>Technology Support</span>
          </div>

          <h2>
            Connect With Our Tech Team <br />
            <em>For Digital Solutions.</em>
          </h2>

          <p>
            Reach our technology team for travel platforms, digital
            integrations, technical support, system enquiries, website support,
            and technology partnership discussions.
          </p>
        </motion.div>
        ...
        <motion.div className={styles.contactLayout} variants={fadeUp}>
          <aside className={styles.infoColumn}>
            ...
            <div className={styles.infoIntro}>
              <span className={styles.panelLabel}>Technology Desk</span>

              <h3>Get In Touch</h3>

              <p>
                For technical enquiries, digital systems, platform support,
                travel technology, integrations, and tech collaboration
                requests.
              </p>
            </div>
          ...
          <div className={styles.formPanel}>
            ...
            <div className={styles.formHeader}>
              <span className={styles.panelLabel}>Send Tech Inquiry</span>

              <h3>Tell us what you need</h3>

              <p>
                Share your technical requirement and our team will review your
                enquiry.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className={styles.form}>
              ...
              <div className={styles.inputGroup}>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  placeholder="Tell us about your technology inquiry..."
                />
              </div>
